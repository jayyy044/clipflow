...
`AutoGeneratedType` is never recorded. That covers 1Password, Bitwarden and Apple
Passwords, and — verified 2026-07-31 — Google Password Manager's copy button in
Chrome, which stored nothing.
